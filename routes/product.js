...
let {addToCart,addProduct,getAllProducts,editProduct,deleteProduct,deleteProductanyone,getRetailerProducts,getByCat,getProductById,addToFav,getFavorite} = require('../controllers/product')
...
Router.delete('/admin/:id', deleteProductanyone),
